...
#define OLED_SCLK_Clr() DL_GPIO_clearPins(I2C_PORT, I2C_SCL_PIN)
#define OLED_SCLK_Set() DL_GPIO_setPins(I2C_PORT, I2C_SCL_PIN)

#define OLED_SDIN_Clr() DL_GPIO_clearPins(I2C_PORT, I2C_SDA_PIN)
#define OLED_SDIN_Set() DL_GPIO_setPins(I2C_PORT, I2C_SDA_PIN)
