...
//  作    者   : HuangKai
//  生成日期   : 2014-0101
//  最近修改   : 2026-07-12 移植到MSPM0G3507
//  功能描述   : OLED字库（8x16 ASCII、6x8 ASCII、16x16汉字）
//版权所有，盗版必究。
 ...
 *     {0x00,0x00, ...},  // 汉字1: "好"
 *   };
 *   调用 OLED_ShowCHinese(x, y, 0) 显示"你"
 *   调用 OLED_ShowCHinese(x, y, 1) 显示"好"
 */
/* 默认空字库，用户可根据需要添加汉字 */
const unsigned char Hzk[][32] = {
